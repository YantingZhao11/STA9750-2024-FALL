...
Overall Increase in Incidents: The post-COVID period saw a marked rise in incidents, likely driven by increased ridership and operational demands.
- **Shifting Categories**: The rise in "persons on trackbed/police/medical" incidents post-COVID indicates a growing safety concern, while the decrease in signal-related incidents suggests operational improvements in this area.
- **Infrastructure Challenges**: The increase in track-related incidents underscores the need for enhanced maintenance strategies.

These insights are critical for addressing the overarching question: "How have delays, on-time performance, and safety incidents influenced the efficiency of subway lines across NYC boroughs from 2020 to 2024?" By identifying the most common incident categories and their variations over time, this report contributes to a broader understanding of the factors impacting subway performance. The findings emphasize the importance of targeted safety measures, infrastructure investment, and data-driven planning to improve the efficiency and resilience of NYC’s subway system.

## Conclusion

The COVID-19 pandemic brought unprecedented challenges to NYC’s subway system, shaping the patterns and dynamics of reported incidents. As ridership recovers, the post-COVID period reveals new safety and operational challenges, with rising incidents across several lines and categories. This analysis provides valuable insights for the MTA to prioritize interventions, allocate resources effectively, and enhance system performance in a post-pandemic world.
