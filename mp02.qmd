...
```
### 2. Low Scoring Movies (Low Success Score, High Votes)  
...
```
### 4. Movies Above Success Threshold  
Lastly, we established a threshold for projects to be considered a ‘success,’ identifying those movies that exceed a success score of **9.89179010376421**:
```{r echo=TRUE, message=FALSE, warning=FALSE}
#| code-fold: true
#| code-summary: "Show the code"
#| 
